...
| 05 | `05-creative` — креативи: карусель/інфографіка/single image (з ідеї + хук-чернетки) | на кожен пост | 🔜 планується |
| 06 | `06-write` — пост під креатив: хуки → скоринг → драфт у голосі → грейдер → publish-ready | на кожен пост | 🔜 планується |
