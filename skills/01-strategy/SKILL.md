...
- **Секція 7 (пілари):** 4–6 піларів; кожен прив'язаний до viral lever
  (`${CLAUDE_PLUGIN_ROOT}/reference/methodology.md` §5) і до доказів компетенції, знайдених
  у п.1. Сума квот = commitment × 4 тижні. Якщо у клієнта мало доказів — більше піларів
  на запасних стратегіях компетенції (methodology §2.3).
...
- Сума квот піларів = commitment × 4.
